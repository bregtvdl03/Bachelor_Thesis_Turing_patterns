...
\begin{definition}
    ...
    forming a Hilbert space. A useful subset of $H^k(\Omega)$ is $H^k_0(\Omega)$, which is defined as the closure of all functions in $H^k(\Omega)$ having compact support in $\Omega$.
