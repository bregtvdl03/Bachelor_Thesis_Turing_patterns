...
This is known as the \emph{differential form} of Gronwall's lemma. We also have an \emph{integral form}, which is especially useful when dealing with non-differentiable functions. 
