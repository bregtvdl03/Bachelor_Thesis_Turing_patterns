...
We derive similar dynamics to the ones used in \cite{iber2014}.The ligands can move freely through the extracellular space. This can be modelled by the standard diffusion (or heat) equation. To simplify the setting, we assume the individual receptors will be fixed in their position on the cell membrane.
