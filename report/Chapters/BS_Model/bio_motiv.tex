...
\begin{equation*}
    p(u, u_b) := p_u + \alpha u_b - d_u u,    \qquad   q(u_b) := - d_{u_b} u_b    \qquad      \text{and}      \qquad      r := p_v,
\end{equation*}
