...
\begin{equation*}
    p(u, u_b) := P_u + \alpha u_b - \delta_u u,    \qquad   q(u_b) := - \delta_{u_b} u_b    \qquad      \text{and}      \qquad      r := P_v,
\end{equation*}
