...
\noindent
This is called a \emph{quasi-steady state}. Using this expression for $u_b$ enables us to simplify \cref{eq:threespeciesmodel} to the two-species model
%
\begin{equation}
